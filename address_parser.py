...
# Группа номера дома: "4", "32/1", "4 корп 1", "5 стр 2", "4 лит а", "29 корп 2 лит с"
# {0,2} — захватываем оба суффикса: корп + лит (например "29 корп 2 лит с" → "29/2/с")
_HOUSE_GROUP = r"(\d+[а-яa-z]?(?:/\d+[а-яa-z]?)?(?:\s+(?:корп|стр|лит)\s+\d*[а-яa-z]*\d*){0,2})"
